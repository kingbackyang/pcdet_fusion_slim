...
class pointpillar(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.backbone_2d = BaseBEVBackboneFusion(config.MODEL.BACKBONE_2D, 64)
...
if __name__ == "__main__":
    import copy
    model_weights = torch.load("/home/mk/OpenPCDet/benchmark/pp_fusion_late_8/pointpillar_fusion_late_8/default/ckpt/checkpoint_epoch_80.pth")
    cfg_file = "/home/mk/OpenPCDet/tools/cfgs/kitti_models/pointpillar_fusion_late_8.yaml"
