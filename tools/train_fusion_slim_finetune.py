...
def parse_config():
    ...
    parser.add_argument('--slimming_type', default="", help='pick which backbone')
...
def main():
    ...
    if len(args.slimming_pth) != 0:
        slimming_model = torch.load(args.slimming_pth)
        model.load_state_dict(slimming_model)
    model.cuda()
